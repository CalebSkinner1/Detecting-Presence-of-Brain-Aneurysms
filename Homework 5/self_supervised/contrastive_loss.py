...
def sim(z_i, z_j):
    ...
    #                                                                            #
    # HINT: torch.linalg.norm might be helpful.  (1 line expected)               #
    ##############################################################################
...
def sim_positive_pairs(out_left, out_right):
    ...
    # Vectorize your code: you may find torch.linalg.norm useful                 #
    # 
    ##############################################################################
...
def compute_sim_matrix(out):
    ...
    ##############################################################################
    # TODO: Start of your code.    2 lines expected of vectorized code           #
    ##############################################################################
